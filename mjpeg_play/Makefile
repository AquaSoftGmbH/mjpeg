...
pkgdatadir = $(datadir)/lavtools
pkglibdir = $(libdir)/lavtools
pkgincludedir = $(includedir)/lavtools
...
lavrec_DEPENDENCIES = 
lavvideo_OBJECTS =  lavvideo.o
lavvideo_LDADD = $(LDADD)
lavvideo_DEPENDENCIES = 
lavvideo_LDFLAGS = 
v4l_conf_OBJECTS =  v4l-conf.o
...
lavrec: $(lavrec_OBJECTS) $(lavrec_DEPENDENCIES)
	@rm -f lavrec
	$(LINK) $(lavrec_LDFLAGS) $(lavrec_OBJECTS) $(lavrec_LDADD) $(LIBS)

lavvideo: $(lavvideo_OBJECTS) $(lavvideo_DEPENDENCIES)
	@rm -f lavvideo
	$(LINK) $(lavvideo_LDFLAGS) $(lavvideo_OBJECTS) $(lavvideo_LDADD) $(LIBS)
