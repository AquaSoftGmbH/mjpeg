...
class Pass2RateCtlState :  public RateCtlState
{
public:
	virtual ~Pass2RateCtlState() {}
	virtual RateCtlState *New() const { return new Pass2RateCtlState; }
	virtual void Set( const RateCtlState &state ) { *this = static_cast<const Pass2RateCtlState &>(state); }
...
class Pass2RateCtl :  public RateCtl,  public Pass2RateCtlState
{
public:
	Pass2RateCtl( EncoderParams &encoder );
