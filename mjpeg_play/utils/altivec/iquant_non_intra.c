...
#define IQUANT_NON_INTRA_PDECL int16_t *src, int16_t *dst, int mquant
#define IQUANT_NON_INTRA_ARGS src, dst, mquant
#define IQUANT_NON_INTRA_PFMT "src=0x%X, dst=0x%X, mquant=%d"
